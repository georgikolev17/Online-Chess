...
namespace WebApiTest
{
    ...
    {
        private static List<Char> WhiteFigures = new List<char>()
        {
            'K',
            'Q',
            'B',
        ...
        private static List<Char> BlackFigures = new List<char>()
        {
            'k',
            'q',
            'b',
        ...
        private static List<char[]> ChessBoard = new List<char[]>()
        {
        ...
        private static int lastMoveStartRow = 0, lastMoveStartCol = 0;
        private static int lastMoveFinalRow = 0, lastMoveFinalCol = 0;
        public State Controller(string startPosition, string finalPosition)
        {
        ...
        private static bool IsTherePossibleMoveForWhite(char[,] chessBoard)
        {
        ...
        private static bool IsTherePossibleMoveForBlack(char[,] chessBoard)
        {
            int countedFigures = 0;
            for (int i = 0; i < 7; i++)
            {
